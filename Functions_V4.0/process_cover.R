...
process_cover = function(cover_raster,
  ...
  rm(aoi_cover_total)
  gc()
  writeRaster(aoi_2018cover_total,paste0(destination,aoi_prefix,"agg and reclass_2020cover_total.tif"),overwrite=TRUE)
  rm(aoi_2018cover_total)
  gc()
  writeRaster(aoi_2018cover_access,paste0(destination,aoi_prefix,"agg and reclass_2020cover_access.tif"),overwrite=TRUE)
